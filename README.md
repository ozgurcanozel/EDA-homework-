...
# 🖼️ Saving Visualizations Automatically
    ...
    plt.savefig("visuals/quality_countplot.png")
    plt.close()

    sns.displot(x="alcohol", data=data, kind="kde")
    plt.savefig("visuals/alcohol_distribution.png")
    plt.close()

    data["quality"].value_counts().plot(kind="pie")
    plt.savefig("visuals/quality_pie.png")
    plt.close()
